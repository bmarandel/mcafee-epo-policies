...
class OASExclusionList:
    """
    The OASExclusionList class can be used to edit the list of exclusion.
    What to exclude:
    ...
    def __repr__(self):
        return '<OASExclusionList which contains {} exclusion(s)>'.format(len(self.excl_list))
